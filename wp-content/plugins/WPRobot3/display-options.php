...
<h1 class="nav-tab-wrapper"><span style="display:inline-block;float:left;margin-top: 6px;">WP Robot&nbsp;&nbsp;&nbsp;</span>
...
<?php } else { ?>
	...
	<!--<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("License Options","wprobot") ?></h3>	
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 	
			<tr valign="top"> 
				...
				<a class="tooltip" href="#">?<span><?php _e('If you own the Developer License of WP Robot you can edit the Paypal email in order to insert a sublicense for your clients.',"wprobot") ?></span></a>
				</td> 
			</tr>		
		</table>		
	-->
	...
	<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("Rewriting","wprobot") ?></h3>
		...
		<?php } else {
		?>		
			<p><?php _e('Individual spinning software setup has been moved to the <strong><a href="?page=ar-settings">All Rewriters</a></strong> settings page.',"wprobot") ?></p>
			<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 		
				<tr valign="top"> 
