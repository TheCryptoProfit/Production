...
function wpr_artipotpost($keyword,$num,$start,$optional="",$comments="",$options,$template,$ua,$proxy,$proxytype,$proxyuser) {
	...
	$search_url = "http://www.artipot.com/search/?g=$page&q=$keyword";
...
function wpr_articlepost($keyword,$num,$start,$optional="",$comments="") {
	...
	if($options["wpr_eza_source"] == "buk") {
		...
		//return wpr_artipotpost($keyword,$num,$start,$optional,$comments,$options,$template,$ua,$proxy,$proxytype,$proxyuser);		
	}
