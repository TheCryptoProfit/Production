		...
		if (isset($pxml->items)) {
			foreach($pxml->items as $entry) {
				...
				*/
				...
				$video ='<iframe width="'.$options['wpr_yt_width'].'" height="'.$options['wpr_yt_height'].'" src="https://www.youtube.com/embed/'.$videoid.'?rel=0" frameborder="0" allowfullscreen></iframe>';
				...
				$vid = str_replace("{videoid}", $videoid, $vid);
