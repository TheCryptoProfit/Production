...
-->
	...
	<div class="" style="border-left: 4px solid #46b450;0 1px 1px 0 rgba(0, 0, 0, 0.1);padding: 1px 12px;background: #fff none repeat scroll 0 0;margin-top: 20px;">
	...
	<div class="" style="border-left: 4px solid #46b450;0 1px 1px 0 rgba(0, 0, 0, 0.1);padding: 1px 12px;background: #fff none repeat scroll 0 0;margin-top: 20px;">
		<a style="float: left;margin: 0 10px 0 0 ;" title="Visit WPscoop!" target="_blank" href="http://wpscoop.com/"><img style="width: 180px;" src="<?php echo plugins_url( '', __FILE__ ); ?>/images/WPscoop-logo.png" alt="WPscoop logo" /></a>	
		<p>Visit my WordPress blog at <a target="_blank" title="Visit WPscoop!" href="http://wpscoop.com/"><strong>WPscoop.com</strong></a> to find useful plugin comparisons, several free plugins and many other WordPress related guides.</p>			
		<div style="clear:left;"> </div>		
	</div>
