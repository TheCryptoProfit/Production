...
function pspMinifyOptions_cache__( $action='default', $istab = '', $is_subtab='' ) {
    global $psp;
...
<div class="psp-form-row psp-minify-cache <?php echo ($istab!='' ? ' '.$istab : ''); ?><?php echo ($is_subtab!='' ? ' '.$is_subtab : ''); ?>">
    ...
    <span style="margin:0px 0px 0px 10px" class="response"><?php echo pspMinifyOptions_cache__( 'getStatus' ); ?></span>
...
function pspMinifyOptions_remote__( $action='default', $istab = '', $is_subtab='' ) {
    global $psp;
...
function pspMinifyOptions_excludingHtml__( $action='default', $istab = '', $is_subtab='' ) {
    global $psp;
...
<div class="psp-form-row psp-minify-exclude <?php echo ($istab!='' ? ' '.$istab : ''); ?><?php echo ($is_subtab!='' ? ' '.$is_subtab : ''); ?>">
    ...
    <span style="margin:0px 0px 0px 10px" class="response"><?php echo pspMinifyOptions_excludingHtml__( 'getStatus' ); ?></span>
...
function pspMinifyOptions_excludingAssets__($assetsType) {
    global $psp;
        ...
        $tryed_module['db_alias'] => array(
            ...
            'Minify' => array(
                ...
                'elements'  => array(
                    ...
                    '__remote' => array(
                        'type' => 'html',
                        'html' => pspMinifyOptions_remote__( 'default', '__tab1', '' )
                    ),
                    
                    '__cache' => array(
                        'type' => 'html',
                        'html' => pspMinifyOptions_cache__( 'default', '__tab1', '' )
                    ),
                    ...
                    '__exclude' => array(
                        'type' => 'html',
                        'html' => pspMinifyOptions_excludingHtml__( 'default', '__tab2', '' )
                    ),
                    ...
                    'exclude_header_styles'    => array(
                        ...
                        'options'   => pspMinifyOptions_excludingAssets__('css:header')
                    ),
                    ...
                    'exclude_header_scripts'    => array(
                        ...
                        'options'   => pspMinifyOptions_excludingAssets__('js:header')
                    ),
                    ...
                    'exclude_footer_scripts'    => array(
                        ...
                        'options'   => pspMinifyOptions_excludingAssets__('js:footer')
                    ),
