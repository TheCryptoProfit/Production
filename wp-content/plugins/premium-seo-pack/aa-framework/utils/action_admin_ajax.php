    ...
    class pspActionAdminAjax
    {
        ...
        */
        public function __construct( $parent )
        {
            ...
            // report
            add_action('wp_ajax_psp_report_settings', array( $this, 'report_actions' ));
            add_action('wp_ajax_nopriv_psp_report_settings', array( $this, 'report_actions' ));
        }
