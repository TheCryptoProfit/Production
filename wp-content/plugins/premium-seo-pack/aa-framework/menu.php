				...
				'submenu' => array(
					...
					'serp' => array(
						...
						'submenu' => array(
							...
							'serp_stats' => array(
								'title' => __( 'SERP Stats', 'psp' ),
								'url' => admin_url('admin.php?page=' . $this->the_plugin->alias . "_SERP_stats"),
							),
						)
					),
					...
					'report' => array(
						...
						'submenu' => array(
							'report_Settings' => array(
								'title' => __( 'PSP Report Settings', 'psp' ),
								'url' => admin_url("admin.php?page=psp#report")
							),
						)
					),
				)
