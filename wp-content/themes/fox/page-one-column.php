    ...
    <div class="content">
        ...
        <main id="primary" class="content-area" role="main">
            ...
            <div class="single-body">
                ...
                <li class="li-pinterest"><a href="javascript:void((function()%7Bvar%20e=document.createElement('script');e.setAttribute('type','text/javascript');e.setAttribute('charset','UTF-8');e.setAttribute('src','https://assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e)%7D)());" title="<?php _e('Google+','wi');?>"><span><?php _e('Pinterest','wi');?></span></a></li>
                    </ul>
                </div><!-- .post-share -->
                <?php endif; ?>
