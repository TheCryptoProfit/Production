        ...
        <main id="primary" class="content-area" role="main">
            ...
            <div class="single-body">
                ...
                <?php if( !get_theme_mod('wi_disable_single_share')): ?>
                    ...
                    <li class="li-twitter"><a data-href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink());?>&amp;text=<?php echo urlencode( html_entity_decode ( get_the_title() ) );?>" title="<?php _e('Twitter','wi');?>" class="share"><span><?php _e('Twitter','wi');?></span></a></li>
                    ...
                    <li class="li-pinterest"><a href="javascript:void((function()%7Bvar%20e=document.createElement('script');e.setAttribute('type','text/javascript');e.setAttribute('charset','UTF-8');e.setAttribute('src','<?php echo is_ssl() ? 'https' : 'http'; ?>://assets.pinterest.com/js/pinmarklet.js?r='+Math.random()*99999999);document.body.appendChild(e)%7D)());" title="<?php _e('Google+','wi');?>"><span><?php _e('Pinterest','wi');?></span></a></li>
                        </ul>
                    </div><!-- .post-share -->
                <?php endif;
