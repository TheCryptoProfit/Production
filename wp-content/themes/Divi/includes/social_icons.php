...
<?php if ( 'on' === et_get_option( 'divi_show_linkedin_icon', 'on' ) ) : ?>
	<li class="et-social-icon et-social-linkedin">
		<a href="<?php echo esc_url( et_get_option( 'divi_linkedin_url', 'https://www.linkedin.com/in/crypto-profit-039a51155/' ) ); ?>" class="icon" target="_blank">
...
<?php if ( 'on' === et_get_option( 'divi_show_youtube_icon', 'on' ) ) : ?>
	<li class="et-social-icon et-social-youtube">
		<a href="<?php echo esc_url( et_get_option( 'divi_youtube_url', 'https://www.youtube.com/channel/UC43F0yXLH6ukz1POccOYJAA' ) ); ?>" class="icon" target="_blank">
...
<?php if ( 'on' === et_get_option( 'divi_show_instagram_icon', 'on' ) ) : ?>
	<li class="et-social-icon et-social-instagram">
		<a href="<?php echo esc_url( et_get_option( 'divi_instagram_url', 'https://www.instagram.com/thecryptoprofit/' ) ); ?>" class="icon" target="_blank">
