...
function ClassifiedTheme_do_login_scr()
		{
			  ...
			  //Any differences will be noted with end of line comments. 
				 ...
				 */
				 if ( !empty( $_REQUEST['redirect_to'] ) ) {
					$redirect_to = get_permalink(get_option('ClassifiedTheme_my_account_page_id'));
				 } else {
					$redirect_to = $_REQUEST['redirect_to'];
				 }
				 
				 if(empty($redirect_to)) $redirect_to = get_permalink(get_option('ClassifiedTheme_my_account_page_id'));
		...
		?>
            ...
            <div class="padd10">
				...
				<form name="loginform" id="loginform" action="<?php bloginfo('siteurl') ?>/wp-login.php" method="post">
